	...
	<body>
		...
		<table align="center" border="1" cellpadding="5">
			...
			<?php
                        ...
                        ?>
			<form action="claimcomplaint.php" method="post">
				...
				<tr><td>Description</td><td><textarea cols="50" rows="20" maxlength="1024" name="description" readonly /><?php echo $description; ?></textarea></td></tr>
				...
				<tr><td>Notes</td><td><textarea cols="50" rows="20" maxlength="1024" name="modnotes" readonly /><?php echo $modnotes; ?></textarea></td></tr>
				<tr><td>Closing Verdict</td><td><input type="text" size="67" name="closingverdict" value="<?php echo $closingverdict; ?>" readonly /></td></tr>
				<tr><td align="center" colspan="3"><input type="submit" value="Claim" /></td></tr>
			</form>
		</table>
	</body>
</html>
