<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (empty($inputedusername)) {
            echo "<center>invalid username, please try again</center>";
            exit;
        }
        if (empty($inputedpassword)) {
            echo "<center>invalid password, please try again<center>";
            exit;
        }
