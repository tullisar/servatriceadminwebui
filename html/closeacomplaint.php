	...
	<body>
		...
		<table align="center" border="1" cellpadding="5">
			...
			<?php
                        ...
                        ?>
			<form action="closecomplaint.php" method="post">
				...
				<tr><td>Closing Verdict</td><td><input type="text" size="67" name="closingverdict"></td></tr>
				<tr><td align="center" colspan="2"><input type="submit" value="Close" /></td></tr>
			</form>
		</table>
	</body>
</html>
